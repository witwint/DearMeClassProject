...
public class QUploadFile extends EntityPathBase<UploadFile> {
    ...
    public final classproject.dearme.domain.user.QUser userImage;

    public final classproject.dearme.domain.user.QUser userImages;
    ...
    public QUploadFile(Class<? extends UploadFile> type, PathMetadata metadata, PathInits inits) {
        ...
        this.userImage = inits.isInitialized("userImage") ? new classproject.dearme.domain.user.QUser(forProperty("userImage"), inits.get("userImage")) : null;
        this.userImages = inits.isInitialized("userImages") ? new classproject.dearme.domain.user.QUser(forProperty("userImages"), inits.get("userImages")) : null;
    }
